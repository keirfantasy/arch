...
#
# Downloads arch-setup.sh to a temp file and runs it with the terminal
# attached, so sudo prompts still work even when this bootstrap is piped.
#
set -euo pipefail

SCRIPT_URL="https://raw.githubusercontent.com/keirfantasy/arch/main/arch-setup.sh"
...
echo "Downloading arch-setup.sh..."
